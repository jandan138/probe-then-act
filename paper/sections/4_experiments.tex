...
\cref{tab:benchmark} summarizes the five material splits. We use Genesis MPM at grid density 128 with 25 substeps per control step (control $\Delta t = 2 \times 10^{-3}$~s). Particles are initialized with $y = 0.02$~m (``Config D''); the source platform ensures that gravity alone does not trivially move particles across the edge.
