...
\begin{itemize}
    ...
    \item \textbf{M8: Privileged Teacher}---an oracle that receives ground-truth material parameters (7-D privileged observation) concatenated to $s_t$. Provides an informational upper bound.
