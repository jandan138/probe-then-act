...
The apparent failure mode is probe-induced degradation on persistent-perturbation substrates. On ID sand, Sand-Hard, Sand-Soft, and snow, \PTA{} underperforms the reactive baseline; these negative signs are part of the paper's diagnostic pattern rather than discarded failures. The recoverability account is a testable heuristic for this sign pattern, scoped by the current benchmark. Follow-up experiments should add recoverable material families, learned probe policies, probe-gating mechanisms, realistic tactile sensors, and sim-to-real deployment.
