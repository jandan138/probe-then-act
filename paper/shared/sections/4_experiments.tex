...
\begin{itemize}
    ...
    \item \textbf{M7: \PTA{} (ours)}---the full two-stage architecture of \cref{sec:method}, with a paired encoder sidecar for claim-bearing matched evaluation.
